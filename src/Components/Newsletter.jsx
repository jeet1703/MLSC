...
const Newsletter = () => {
  ...
  return (
    <Section  crosses className="relative bg-transparent !px-0 !py-10">
      <div className="relative z-10 mx-4 lg:mx-20 my-8 lg:my-24"> {/* Adjusted margin for different screen sizes */}
        <h2 className="text-4xl md:text-6xl  text-white text-center mb-6">Newsletter</h2> {/* Added margin bottom for spacing */}
